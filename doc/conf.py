# -*- coding: utf-8 -*-
#
# comparator documentation build configuration file, created by
...
htmlhelp_basename = 'comparatordoc'
...
latex_documents = [
  ('index', 'comparator.tex', u'comparator Documentation',
...
man_pages = [
    ('index', 'comparator', u'comparator Documentation',
...
texinfo_documents = [
  ('index', 'comparator', u'comparator Documentation',
   u'Benjamin Alan Weaver', 'comparator', 'One line description of project.',
   'Miscellaneous'),
]
